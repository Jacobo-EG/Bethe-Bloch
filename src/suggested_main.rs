...
fn plot(energies: &Vec, stopping_powers: &Vec, 
        caption: &str, title: &str){ // TODO: Pasar las cosas hardcodeadas a parametros de la funcion
    ...
    let mut fg = Figure::new();
    {
        ...
        axes.set_y_range(Fix(0.0), Fix(100.0));
